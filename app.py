...
with sub_log:
    ...
    # 1. ปุ่มรีเฟรชข้อมูล (เพื่อดึงข้อมูลล่าสุดจาก Supabase)
    ...
    # 3. แสดงกราฟแนวโน้มอุณหภูมิ (จาก temp_frequent_logs)
    ...
    if prod_logs:
        ...
        # จัดการข้อมูล nested ของ Supabase
